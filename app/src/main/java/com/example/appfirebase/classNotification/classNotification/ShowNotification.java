...
import com.example.appfirebase.ChefFoodPanel_BottomNavigation;
import com.example.appfirebase.ChefLogin;
import com.example.appfirebase.CustomerFoodPanel_BottomNavigation;
...
public class ShowNotification {
    ...
    public static void ShowNotif(Context context, String title, String message, String page) {
        String CHANNEL_ID = "NOTICEID";
        String CHANNEL_NAME = "NOTICENAME";
        ...
        Intent acIntent = new Intent(context, ChefLogin.class);
        ...
        if (page.trim().equalsIgnoreCase("customerCart")) {
        ...
        if (page.trim().equalsIgnoreCase("Payment")) {
            acIntent = new Intent(context, PayPallOrders.class);
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("DeliveryOrder")) {
            acIntent = new Intent(context, ChefFoodPanel_BottomNavigation.class).putExtra("PAGE", "DeliveryOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("RejectOrder")) {
            acIntent = new Intent(context, ChefFoodPanel_BottomNavigation.class).putExtra("PAGE", "RejectOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        int random = new Random().nextInt(99999 - 1) + 1;

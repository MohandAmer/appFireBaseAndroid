...
public class Deleveryclass {
    ...
    public Deleveryclass() {
    }

    public Deleveryclass(String fname, String lname, String emailid, String password, String confermpassword, String mobile, String house, String area) {
        this.fname = fname;
        this.lname = lname;
        this.emailid = emailid;
        this.password = password;

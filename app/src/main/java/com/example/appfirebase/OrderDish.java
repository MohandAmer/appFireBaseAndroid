                            ...
                            public void onClick(View view) {
                                try {
                                    ...
                                    dataref.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                                            Cart cart1 = null;
                                            int addtm =Integer.parseInt(additem.getNumber());
                                            int convertedstr =Integer.parseInt(updateDishModel.getQuantity());
                                            if (convertedstr < addtm){
                                                Toast.makeText(OrderDish.this,"هل تتهابل لقد تجاوزت الحد المسموح",Toast.LENGTH_SHORT).show();
